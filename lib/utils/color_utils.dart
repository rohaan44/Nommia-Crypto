...
class AppColor {
  ...
  static const Color c333333 = Color(
    0xFF333333,
  ); // A slightly lighter grey for the icon circle
  static const Color cB0B0B0 = Color(
    0xFFB0B0B0,
  ); // A light grey for the subtitle
  ...
  static const c0C1010 = Color(0xff0C1010);
  static const c787B7F = Color(0xff787B7F);
  static const c121717 = Color(0xff121717);
  static const cBF8C15 = Color(0xffBF8C15);
  static const cDAA934 = Color(0xffDAA934);
